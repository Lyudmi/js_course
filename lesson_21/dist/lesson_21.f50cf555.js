    ...
    _createClass(LocationApi, [{
        ...
        value: function getMyIp() {
            ...
            return fetch('https://api.ipify.org?format=json').then(function (resolve) {
                ...
                return console.log('error ip: ', reject);
            });
        }
    }, {
        key: 'getMyLocation',
        value: function getMyLocation(your_Ip) {
            return fetch('https://freegeoip.net/json/' + your_Ip).then(function (resolve) {
                if (resolve.status === 200) {
                    return resolve.json();
                }
                throw new Error('error');
            }).catch(function (reject) {
                return console.log('Error: ' + reject);
            });
        }
    }]);
...
},{"./location_api":6,"./dom":7}],14:[function(require,module,exports) {
...
//# sourceMappingURL=/lesson_21.f50cf555.map